...
//$stmt = $conn->prepare("SELECT `id`, `question`, `answer1`, `answer2`, `answer3`, `answer4`, `correct_answer` , `explain_answer` , `setNo` FROM `railexam`");
//$stmt = $conn->prepare("SELECT `id`, `question`, `answer1`, `answer2`, `answer3`, `answer4`, `correct_answer` , `explain_answer` , `setNo` FROM `railexam` WHERE setNo = $paperSetNo");
//$stmt = $conn->prepare("SELECT `id`, `question`, `answer1`, `answer2`, `answer3`, `answer4`, `correct_answer` , `setNo` FROM `railexam` WHERE setNo = $paperSetNo");

$stmt = $conn->prepare("SELECT `id`, `question`, `answer1`, `answer2`, `answer3`, `answer4`, `correct_answer` , `user_answer` FROM `railexam` WHERE setNo = $paperSetNo");
