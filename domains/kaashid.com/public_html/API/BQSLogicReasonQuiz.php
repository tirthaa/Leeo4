...
$stmt = $conn->prepare("SELECT `id`, `question`, `questionImg`, `answer1`, `answer2`, `answer3`, `answer4`, `answer5`, `correct_answer`, `user_answer`, `design` FROM `LogicQuestion` WHERE setNo = $paperSetNo");
